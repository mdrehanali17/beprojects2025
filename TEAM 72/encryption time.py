...
def zeta_z_operation():
    ...
    # Save the encrypted image
        ...
        print("Zeta-Z Operation Time:", total_time, "seconds")
...
def encrypt_and_display_image():
    ...
    end_time = time.time()  # End time measurement
    total_time = end_time - start_time
    print("Arnold Cat Map Encryption Time:", total_time, "seconds")
...
def browse_image_encrypt_and_diffuse():
    ...
    end_time = time.time()  # End time measurement
    total_time = end_time - start_time
    print("Diffusion Operation Time:", total_time, "seconds")
def measure_total_encryption_time():
    start_time = time.time()  # Start time measurement

    # Call encryption functions
    zeta_z_operation()
    encrypt_and_display_image()
    browse_image_encrypt_and_diffuse()
   
    # Add similar calls for other encryption steps

    end_time = time.time()  # End time measurement
    total_time = end_time - start_time
    print("Total Encryption Time:", total_time, "seconds")

# Call the main function to measure total encryption time
measure_total_encryption_time()
...
def browse_cipher_image():
    ...
    if file_path:
        ...
        cipher_image = cipher_image.resize((512,512))  # Custom size: (width, height)
...
encryption_label.place(x=820,y=100)
...
zeta_z_button.place(x=button_x+800, y=button_y+100)
...
confusion_button.place(x=button_x+800, y=button_y+165)
...
diffusion_button.place(x=button_x+800,y=button_y+230)
...
decryption_label.place(x=820,y=450)
...
browse_cipher_button.place(x=button_x+800, y=button_y+400)
...
reverse_diffusion_button.place(x=button_x+800,y=button_y+450)
...
arnoldcatdecryption.place(x=button_x+800, y=button_y+515)
...
decrypt_button.place(x=button_x+800, y=button_y+580)
