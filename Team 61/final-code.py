...
CONSOLIDATED_DESTINATION = "./dataset/consolidated-data.csv"
...
df = df.drop(["throughput_node"], axis=1)
...
df.to_csv("./dataset/feature-engineered.csv", index=False)
...
df_test = pd.read_csv("./dataset/feature-engineered.csv")
